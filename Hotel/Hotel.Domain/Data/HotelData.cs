...
public static class HotelData
{
    ...
    [
        ...
        new Booking { Id = 3, Client = Clients[2], Room = Rooms[6], CheckInDate = new DateTime(2026, 9, 9), DaysCount = 2 },
        new Booking { Id = 4, Client = Clients[3], Room = Rooms[6], CheckInDate = new DateTime(2026, 9, 11), DaysCount = 4 },
        new Booking { Id = 5, Client = Clients[4], Room = Rooms[6], CheckInDate = new DateTime(2026, 9, 15), DaysCount = 7 },
        new Booking { Id = 6, Client = Clients[5], Room = Rooms[2], CheckInDate = new DateTime(2026, 8, 1), DaysCount = 3 },
        new Booking { Id = 7, Client = Clients[6], Room = Rooms[2], CheckInDate = new DateTime(2026, 8, 4), DaysCount = 6 },
        new Booking { Id = 8, Client = Clients[7], Room = Rooms[2], CheckInDate = new DateTime(2026, 8, 10), DaysCount = 2 },
        new Booking { Id = 9, Client = Clients[8], Room = Rooms[2], CheckInDate = new DateTime(2026, 8, 12), DaysCount = 5 },
        new Booking { Id = 10, Client = Clients[9], Room = Rooms[9], CheckInDate = new DateTime(2026, 7, 1), DaysCount = 4 },
        new Booking { Id = 11, Client = Clients[0], Room = Rooms[9], CheckInDate = new DateTime(2026, 7, 5), DaysCount = 3 },
        new Booking { Id = 12, Client = Clients[1], Room = Rooms[9], CheckInDate = new DateTime(2026, 7, 8), DaysCount = 2 },
        new Booking { Id = 13, Client = Clients[2], Room = Rooms[1], CheckInDate = new DateTime(2026, 6, 1), DaysCount = 4 },
        new Booking { Id = 14, Client = Clients[3], Room = Rooms[1], CheckInDate = new DateTime(2026, 6, 5), DaysCount = 3 },
        new Booking { Id = 15, Client = Clients[4], Room = Rooms[4], CheckInDate = new DateTime(2026, 5, 1), DaysCount = 6 },
        new Booking { Id = 16, Client = Clients[5], Room = Rooms[4], CheckInDate = new DateTime(2026, 5, 7), DaysCount = 3 },
        new Booking { Id = 17, Client = Clients[6], Room = Rooms[0], CheckInDate = new DateTime(2026, 4, 1), DaysCount = 2 },
        new Booking { Id = 18, Client = Clients[7], Room = Rooms[3], CheckInDate = new DateTime(2026, 4, 10), DaysCount = 4 },
        new Booking { Id = 19, Client = Clients[8], Room = Rooms[5], CheckInDate = new DateTime(2026, 3, 1), DaysCount = 5 },
        new Booking { Id = 20, Client = Clients[9], Room = Rooms[7], CheckInDate = new DateTime(2026, 3, 10), DaysCount = 2 }
        new Booking { Id = 21, Client = Clients[10], Room = Rooms[3], CheckInDate = new DateTime(2026, 8, 5), DaysCount = 4 },
        new Booking { Id = 22, Client = Clients[10], Room = Rooms[5], CheckInDate = new DateTime(2026, 8, 3), DaysCount = 7 }
    ];
}